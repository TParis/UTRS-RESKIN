 ...
 */
 ...
 namespace App\Library\Peachy\Includes;
...
class Peachy {
	 ...
	 */
	public static function newWiki( $config = null, $pgUsername = null, $password = null, $base_url = 'http://en.wikipedia.org/w/api.php', $classname = 'Wiki' ) {
		...
		if( !is_null( $config ) ) {
			$config_params = self::parse_config( $config );
